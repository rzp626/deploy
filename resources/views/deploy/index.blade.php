...
<div class="box box-default output-box">
    ...
    <div class="box-body">
        ...
        <span><a class="btn btn-sm btn-primary grid-refresh" href="{{ url('admin/deployments') }}">返回</a> <div class="btn-group" style="margin-right: 10px" data-toggle="buttons"></div></span>
    </div>
    <!-- /.box-body -->
</div>
